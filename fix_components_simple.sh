...
Simplified LevelProgress and PointSystem components:
- Removed template literals
- Used string concatenation for dynamic values
EOF

echo "Components simplified. Please run 'npm run dev' to see the changes."
